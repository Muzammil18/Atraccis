...
public class Service_SnoozeAlarm extends Service {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		wakeLock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK,	" com.example.atracc::AlarmSnoozeServiceWakelockTag");
	...
	private void createNotificationChannel() {
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
			...
			NotificationChannel channel = new NotificationChannel(Integer.toString(NOTIFICATION_ID), " com.example.atracc Notifications",
					importance);
