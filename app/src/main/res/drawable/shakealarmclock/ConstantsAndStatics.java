...
final class ConstantsAndStatics {
	 ...
	 * user.
	 */
	static final String BUNDLE_KEY_ALARM_DETAILS = " com.example.atracc.ALARM_DETAILS_BUNDLE";

	/**
	 * Bundle key for the alarm hour. The value is an integer.
	 */
	static final String BUNDLE_KEY_ALARM_HOUR = " com.example.atracc.ALARM_HOUR";

	/**
	 * Bundle key for the alarm minute. The value is an integer.
	 */
	static final String BUNDLE_KEY_ALARM_MINUTE = " com.example.atracc.ALARM_MINUTES";
	 ...
	 */
	static final String BUNDLE_KEY_ALARM_TYPE = " com.example.atracc.ALARM_TYPE";

	/**
	 * Bundle key for the alarm volume. The value is an integer.
	 */
	static final String BUNDLE_KEY_ALARM_VOLUME = " com.example.atracc.ALARM_VOLUME";

	/**
	 * Bundle key for the alarm snooze interval. The value is an integer.
	 */
	static final String BUNDLE_KEY_SNOOZE_TIME_IN_MINS = " com.example.atracc.SNOOZE_TIME_IN_MINS";

	/**
	 * Bundle key for the number of times the alarm should snooze itself. The value is an integer.
	 */
	static final String BUNDLE_KEY_SNOOZE_FREQUENCY = " com.example.atracc.SNOOZE_FREQUENCY";

	/**
	 * Bundle key denoting whether repeat is on or off. Value is boolean.
	 */
	static final String BUNDLE_KEY_IS_REPEAT_ON = " com.example.atracc.IS_REPEAT_ON";

	/**
	 * Bundle key denoting whether snooze is on or off. Value is boolean.
	 */
	static final String BUNDLE_KEY_IS_SNOOZE_ON = " com.example.atracc.IS_SNOOZE_ON";

	/**
	 * Bundle key denoting whether alarm is on or off. Value is boolean.
	 */
	static final String BUNDLE_KEY_IS_ALARM_ON = " com.example.atracc.IS_ALARM_ON";

	/**
	 * Bundle key for the alarm repeat days. The value is an ArrayList of Integer type. Monday is 1 and Sunday is 7.
	 */
	static final String BUNDLE_KEY_REPEAT_DAYS = " com.example.atracc.REPEAT_DAYS";
	 ...
	 */
	static final String ACTION_DELIVER_ALARM = " com.example.atracc.DELIVER_ALARM";

	/**
	 * The day on which the alarm is supposed to ring.
	 */
	static final String BUNDLE_KEY_ALARM_DAY = " com.example.atracc.ALARM_DAY";

	/**
	 * The month in which the alarm will ring.
	 */
	static final String BUNDLE_KEY_ALARM_MONTH = " com.example.atracc.ALARM_MONTH";

	/**
	 * The year in which the alarm will ring.
	 */
	static final String BUNDLE_KEY_ALARM_YEAR = " com.example.atracc.ALARM_YEAR";

	/**
	 * Bundle key for the personalised alarm message.
	 */
	static final String BUNDLE_KEY_ALARM_MESSAGE = " com.example.atracc.ALARM_MESSAGE";

	/**
	 * Bundle key for Uri of the alarm tone.
	 */
	static final String BUNDLE_KEY_ALARM_TONE_URI = " com.example.atracc.ALARM_TONE_URI";

	/**
	 * Bundle key: Indicates whether the user has explicitly chosen a date for that alarm.
	 */
	static final String BUNDLE_KEY_HAS_USER_CHOSEN_DATE = " com.example.atracc.HAS_USER_CHOSEN_DATE";
	 ...
	 */
	static final String ACTION_SNOOZE_ALARM = " com.example.atracc.SNOOZE_ALARM";
	 ...
	 */
	static final String ACTION_CANCEL_ALARM = " com.example.atracc.CANCEL_ALARM";

	/**
	 * The name of the {@link android.content.SharedPreferences} file for this app.
	 */
	static final String SHARED_PREF_FILE_NAME = " com.example.atracc.SHARED_PREF_FILE";

	/**
	 * Intent action indicating that {@link Activity_AlarmDetails} should prepare for a new alarm.
	 */
	static final String ACTION_NEW_ALARM = " com.example.atracc.ACTION_NEW_ALARM";

	/**
	 * Intent action indicating that {@link Activity_AlarmDetails} should show the details of an old alarm.
	 */
	static final String ACTION_EXISTING_ALARM = " com.example.atracc.ACTION_EXISTING_ALARM";
	 ...
	 * button.
	 */
	static final String ACTION_NEW_ALARM_FROM_INTENT =	" com.example.atracc.ACTION_NEW_ALARM_FROM_INTENT";
	 ...
	 * true}.
	 */
	static final String EXTRA_PLAY_RINGTONE = " com.example.atracc.EXTRA_PLAY_RINGTONE";
	 ...
	 */
	static final String BUNDLE_KEY_OLD_ALARM_HOUR = " com.example.atracc.OLD_ALARM_HOUR";
	 ...
	 */
	static final String BUNDLE_KEY_OLD_ALARM_MINUTE = " com.example.atracc.OLD_ALARM_MINUTE";

	/**
	 * Bundle key for the alarm ID.
	 */
	static final String BUNDLE_KEY_ALARM_ID = " com.example.atracc.OLD_ALARM_ID";

	/**
	 * Broadcast action: {@link Activity_RingAlarm} should now be destroyed.
	 */
	static final String ACTION_DESTROY_RING_ALARM_ACTIVITY = " com.example.atracc.DESTROY_RING_ALARM_ACTIVITY";
	 ...
	 */
	static final String SHARED_PREF_KEY_PERMISSION_WAS_ASKED_BEFORE = " com.example.atracc.PERMISSION_WAS_ASKED_BEFORE";
	 ...
	 */
	static final String SHARED_PREF_KEY_DEFAULT_SHAKE_OPERATION = " com.example.atracc.DEFAULT_SHAKE_OPERATION";
	 ...
	 */
	static final String SHARED_PREF_KEY_DEFAULT_POWER_BTN_OPERATION = " com.example.atracc.DEFAULT_POWER_BTN_OPERATION";

	/**
	 * {@link android.content.SharedPreferences} key to store the sensitivity of the shake detector. The data type is {@code float}.
	 */
	static final String SHARED_PREF_KEY_SHAKE_SENSITIVITY = " com.example.atracc.SHAKE_SENSITIVITY";
	 ...
	 */
	static final String SHARED_PREF_KEY_SHOW_BATTERY_OPTIM_DIALOG = " com.example.atracc.SHOW_BATTERY_OPTIM_DIALOG";
	 ...
	 */
	static final String SHARED_PREF_KEY_DEFAULT_SNOOZE_IS_ON = " com.example.atracc.DEFAULT_SNOOZE_STATE";

	/**
	 * {@link android.content.SharedPreferences} key to store the default snooze interval in minutes.
	 */
	static final String SHARED_PREF_KEY_DEFAULT_SNOOZE_INTERVAL = " com.example.atracc.DEFAULT_SNOOZE_INTERVAL";
	...
	/**
	 * Indicates that the theme of the app should be light. Corresponds to {@link AppCompatDelegate#MODE_NIGHT_FOLLOW_SYSTEM}. Available
	 * only on Android Q+.
	 */
